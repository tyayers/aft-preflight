...
export class TestlocalProxy {
  ...
  async handle(req: Request): Promise<Response> {
    ...
    try {
      ...
      // Policy: OAS-Validation (OASValidation)
      ...
      const targetBaseUrl = "https://aiplatform.googleapis.com/v1/projects/{organization.name}/locations/global/publishers/{ai.provider}/models/{ai.model}:{ai.method}";
        ...
        return new Response(
          async function* () {
            if (response && response.body) {
              ...
              // Policy: DC-TokenAnalytics (DataCapture)
